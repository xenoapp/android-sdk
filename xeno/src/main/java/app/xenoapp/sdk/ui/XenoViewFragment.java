...
public class XenoViewFragment extends Fragment {
    private static final String TAG = XenoViewFragment.class.getSimpleName();
    ...
    public XenoViewFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.xeno_view, container, false);

        mWebView = rootView.findViewById(R.id.xeno_view_webview);
    ...
    protected void handleXenoToLink(String url) {
    ...
    public void goBack() {
        execute("if (typeof _xeno === 'undefined' || !_xeno.goBackToPreviousView()) { document.location.href = 'xeno://closeButtonPressed' }");
    }
